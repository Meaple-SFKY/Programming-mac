...
> 随着手机的普及,目前移动端成为所有人接收信息的最快速有效的来源。为了加快数据传递过程,方便用户查看轻量化模型,在轻量化平台置入二维码系统,数据通过二维码传输,每一个轻量化模型都可以通过二维码发送至移动终端。通过生成二维码,项目的所有工作人员用手机扫码都可以查看和利用轻量化模型,使BIM技术平易近人,便于使用。
