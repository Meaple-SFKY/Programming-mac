...
#分词后写入中间表--训练集
oldpath = r'/Users/sfky/Documents/Programming/Python_Folder/bayes/data/training'
newpath = r'/Users/sfky/Documents/Programming/Python_Folder/bayes/mid/train'
...
for f in files:
    ...
    fp.close()
#分词后写入中间表--测试集  
oldpath = r'/Users/sfky/Documents/Programming/Python_Folder/bayes/data/test'
newpath = r'/Users/sfky/Documents/Programming/Python_Folder/bayes/mid/test'
files=os.listdir(oldpath)
for f in files:
    oldfile=os.path.join(oldpath,f)
    newfile=os.path.join(newpath,f)
...
for f in files:
    ...
    fp.close()
#得到停用词   
stop_words=make_words_set(r'/Users/sfky/Documents/Programming/Python_Folder/bayes/stop_words.txt')
...
with open (r'/Users/sfky/Documents/Programming/Python_Folder/bayes/feature_word.txt','w',encoding='utf-8') as fp:  
