...
def getTrainedModelInfo():
    ...
    vocabularyList = getVocabularyList(
        '/Users/sfky/Documents/Programming/Python_Folder/NaiveBayes/SimpleNavieBayes/vocabularyList.txt')
    pWordsHealthy = np.loadtxt(
        '/Users/sfky/Documents/Programming/Python_Folder/NaiveBayes/SimpleNavieBayes/pWordsHealthy.txt', delimiter='\t')
    pWordsSpamicity = np.loadtxt(
        '/Users/sfky/Documents/Programming/Python_Folder/NaiveBayes/SimpleNavieBayes/pWordsSpamicity.txt', delimiter='\t')
    fr = open(
        '/Users/sfky/Documents/Programming/Python_Folder/NaiveBayes/SimpleNavieBayes/pSpam.txt')
